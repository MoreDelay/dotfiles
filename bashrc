...
__conda_setup="$('/home/delay/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/delay/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/delay/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/delay/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# wrapper j for autojump
. /usr/share/autojump/autojump.sh

# QT install in /opt
if [ -d /opt/Qt/6.3.0/gcc_64 ] ; then
    PATH="/opt/Qt/6.3.0/gcc_64/bin:$PATH"
fi
